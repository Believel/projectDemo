...
(function() {
                ...
                domReady: function() {
                    ...
                    return function(b) {
                        ...
                        if (1 == c.length)
                            ...
                            b = !1;
                            try { b = !window.frameElement } catch (u) {}
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) {
        ...
        return {
            ...
            on: function(b, d, g, k, l) {
                function m(a, e, A, l) { a = { name: b, sender: this, editor: a, data: e, listenerData: k, stop: A, cancel: l, removeListener: u };
                    return !1 === d.call(g, a) ? !1 : a.data }

                function u() { A.removeListener(b, d) }
                var e = a.call(this, b);
                if (0 > e.getListenerIndex(d)) { e = e.listeners;
                    g || (g = this);
                    isNaN(l) && (l = 10);
                    var A = this;
                    m.fn = d;
                    ...
                    for (var r = e.length - 1; 0 <= r; r--)
                        if (e[r].priority <= l) return e.splice(r + 1, 0, m), { removeListener: u };
                    e.unshift(m) }
            ...
            fire: function() {
                ...
                return function(l, m, u) {
                    ...
                    if (e) {
                        var r = e.listeners;
                        if (r.length)
                            for (var r = r.slice(0), x, D = 0; D < r.length; D++) {
                                if (e.errorProof) try {
                                    x =
                                        r[D].call(this, u, m, b, k)
                                } catch (q) {} else x = r[D].call(this, u, m, b, k);
        ...
        CKEDITOR.tools = {
            ...
            extend: function(a) {
                var e = arguments.length,
                    b, c; "boolean" == typeof(b = arguments[e - 1]) ? e-- : "boolean" == typeof(b = arguments[e - 2]) && (c = arguments[e - 1], e -= 2);
                for (var l = 1; l < e; l++) {
                    var d = arguments[l],
                        q;
                    for (q in d)
            ...
            transformPlainTextToHtml: function(a, e) {
                ...
                return c = c.replace(/(>|\s) /g,
                    function(a, e) {
                        return e + "\x26nbsp;" }).replace(/ (?=<)/g, "\x26nbsp;")
            },
            ...
            addFunction: function(b, e) {
                return a.push(function() {
                    return b.apply(e || this, arguments) }) - 1 },
            ...
            convertToPx: function() {
                var a;
                return function(e) { a || (a = CKEDITOR.dom.element.createFromHtml('\x3cdiv style\x3d"position:absolute;left:-9999px;top:-9999px;margin:0px;padding:0px;border:0px;"\x3e\x3c/div\x3e', CKEDITOR.document), CKEDITOR.document.getBody().append(a));
            ...
            normalizeCssText: function(a, e) {
                var b = [],
                    c, l = CKEDITOR.tools.parseCssText(a, !0, e);
            ...
            parseCssText: function(a, b, c) {
                ...
                a.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g,
                    function(a, c, d) { b && (c = c.toLowerCase(), "font-family" == c && (d = d.replace(/\s*,\s*/g, ",")), d = CKEDITOR.tools.trim(d));
                        l[c] = d });
                return l
            },
            ...
            getCookie: function(a) { a = a.toLowerCase();
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
        ...
        getAscendant: function(a, d) {
            var b = this.$,
                c, f;
            d || (b = b.parentNode);
            "function" == typeof a ? (f = !0, c = a) : (f = !1, c = function(b) { b = "string" == typeof b.nodeName ? b.nodeName.toLowerCase() : "";
    ...
    (function() {
        ...
        function c(a) {
            for (var b = 0, c = 0, e = k[a].length; c < e; c++) b += parseInt(this.getComputedStyle(k[a][c]) || 0, 10) || 0;
            return b }
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            addClass: f ? function(a) { this.$.classList.add(a);
            ...
            setHtml: CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? function(a) {
                try {
                    ...
                    b.innerHTML = a;
                    c.removeChild(b);
                    return a } catch (e) { this.$.innerHTML = "";
            ...
            removeStyle: function(a) {
                ...
                if (b.removeProperty || "border" != a && "margin" != a && "padding" != a) b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style");
                    ...
                    for (var b = [], d = 0; d < c.length; d++)
                        if (e)
                            for (var r =
                                    0; r < e.length; r++) b.push([a, c[d], e[r]].join("-"));
            ...
            getDocumentPosition: function(a) {
                ...
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                    ...
                    k && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || g.scrollLeft, c = d.$.scrollTop || g.scrollTop) : (c = r ? d.$ : g, b = c.scrollLeft, c = c.scrollTop), b = f.left + b - w, c = f.top + c - q) } else
                    for (q = this, w = null; q && "body" != q.getName() &&
                ...
                if (b) { do
                        if ((b.$.clientWidth && b.$.clientWidth < b.$.scrollWidth || b.$.clientHeight && b.$.clientHeight < b.$.scrollHeight) && !b.is("body") && this.scrollIntoParent(b, a, 1), b.is("html")) {
                            ...
                            try {
                                ...
                                e && (b = new CKEDITOR.dom.element(e)) } catch (d) {} }
                    while (b = b.getParent()) } },
    ...
    (function() {
        function a(a, b) {
            ...
            for (; e && !this._.end;) { this.current = e;
                if (!this.evaluator || !1 !== this.evaluator(e)) {
                    if (!b) return e } else if (b && this.evaluator) return !1;
                e = e[n](!1, p, v) }
            this.end();
        ...
        CKEDITOR.dom.walker.invisible =
            function(a) {
                ...
                return function(e) { b(e) ? e = 1 : (e.type == CKEDITOR.NODE_TEXT && (e = e.getParent()), e = e.$.offsetWidth <= c);
                    return !!(a ^ e) } };
        ...
        CKEDITOR.dom.walker.ignored =
            function(a) {
                return function(b) { b = g(b) || k(b) || l(b);
                    return !!(a ^ b) } };
    ...
    (function() {
        ...
        function d(a, b, c, d, f) {
            ...
            function g() {
                ...
                for (a = 0; a < e; a++)
                    if (b = N[a], c = B[a], !b.equals(c)) return a;
                return a - 1 }
            ...
            var p = a.startContainer,
                ...
                z = a.endOffset,
                J, E, C, u, m, O;
            if (h && n.type == CKEDITOR.NODE_TEXT && p.equals(n)) p = a.document.createText(p.substring(y, z)), c.append(p);
            else {
                ...
                for (var N = p.getParents(), B = n.getParents(), I = g(), F = N.length - 1, K = B.length - 1, G = c, L, Z, U, fa = -1, Q = I; Q <= F; Q++) {
                    Z =
                        N[Q];
                    U = Z.getNext();
                    for (Q != F || Z.equals(B[Q]) && F < K ? b && (L = G.append(Z.clone(0, f))) : J ? q(Z, G, !1, C) : m && G.append(a.document.createText(Z.substring(y))); U;) {
                        if (U.equals(B[Q])) { fa = Q;
                            break }
                        U = q(U, G) }
                    G = L
                }
                G = c;
                for (Q = I; Q <= K; Q++)
                    if (c = B[Q], U = c.getPrevious(), c.equals(N[Q])) b && (G = G.getChild(0));
                    else { Q != K || c.equals(N[Q]) && K < F ? b && (L = G.append(c.clone(0, f))) : E ? q(c, G, !1, u) : O && G.append(a.document.createText(c.substring(0, z)));
                        if (Q > fa)
                            for (; U;) U = q(U, G, !0);
                        G = L }
                h || k()
        ...
        function f(a) {
            return function() {
                var b;
                return this[a ?
                    "getPreviousNode" : "getNextNode"](function(a) {!b && u(a) && (b = a);
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            createBookmark2: function() {
                function a(b) {
                    ...
                    f && (e = e.getChild(d -
                        1), d = e.getLength());
                    if (e.type == CKEDITOR.NODE_ELEMENT && 0 < d) { a: {
                            for (f = e; d--;)
                                if (g = f.getChild(d).getIndex(!0), 0 <= g) { d = g;
                                    break a }
                            d = -1 }
                        d += 1 }
                    if (e.type == CKEDITOR.NODE_TEXT) { f = e;
                        for (g = 0;
            ...
            enlarge: function(a, b) {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        var q = function(a, b) {
                            ...
                            for (c.guard = function(a) {
                                    return !(a.type == CKEDITOR.NODE_ELEMENT && a.isBlockBoundary()) }; e =
                                c.next();) {
                        ...
                        for (h = c(h); h || p;) {
                            ...
                            for (; p;)
                                if (z = !1, p.type == CKEDITOR.NODE_COMMENT) p = p.getPrevious();
                                    ...
                                    if (p.type == CKEDITOR.NODE_TEXT) J = p.getText(), d.test(J) && (p = null), z = /[\s\ufeff]$/.test(J);
                                    else if ((p.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && p.is("br")) && !p.data("cke-bookmark"))
                                        if (y && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                            J = p.getText();
                                            if (d.test(J)) p = null;
                                            else
                                                for (var E = p.$.getElementsByTagName("*"), C = 0, u; u =
                                                    E[C++];)
                                                    if (!CKEDITOR.dtd.$removeEmpty[u.nodeName.toLowerCase()]) { p = null;
                                                        break }
                                            p && (z = !!J.length)
                                        } else p = null;
                                    ...
                                    if ((0 < p.$.offsetWidth || b && p.is("br")) && !p.data("cke-bookmark"))
                                        if (y && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                            ...
                                            if (d.test(J)) p = null;
                                                ...
                                                for (E = p.$.getElementsByTagName("*"), C =
                                                    0; u = E[C++];)
                                                    if (!CKEDITOR.dtd.$removeEmpty[u.nodeName.toLowerCase()]) { p = null;
                                                        break }
                                            p && (z = !!J.length)
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var m, O, N = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null),
                            B = null,
                            I = function(a) {
            ...
            removeEmptyBlocksAtEnd: function() {
                ...
                return function(b) {
                    for (var c = this.createBookmark(), d = this[b ? "endPath" : "startPath"](), f = d.block ||
                            d.blockLimit, g; f && !f.equals(d.root) && !f.getFirst(a(f));) g = f.getParent(), this[b ? "setEndAt" : "setStartAt"](f, CKEDITOR.POSITION_AFTER_END), f.remove(1), f = g;
                    this.moveToBookmark(c)
                }
            }(),
            startPath: function() {
            ...
            moveToClosestEditablePosition: function(a, b) {
                var c, d = 0,
                    f, q, g = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START];
                a ? (c = new CKEDITOR.dom.range(this.root), c.moveToPosition(a, g[b ? 0 : 1])) : c = this.clone();
                if (a && !a.is(CKEDITOR.dtd.$block)) d = 1;
                else if (f = c[b ? "getNextEditableNode" : "getPreviousEditableNode"]()) d = 1, (q = f.type == CKEDITOR.NODE_ELEMENT) &&
            ...
            _find: function(a, b) {
                ...
                if (c && c.find)
                    for (g = c.find(a), q = 0; q < g.count(); q++)
                        if (c = g.getItem(q), b || !c.isReadOnly()) k = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c), l = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED,
                            k && l && f.push(c);
                return f
            }
        }
    ...
    (function() {
        ...
        function b(a, c, f, g) {
            a: { null == g && (g = d(f));
                for (var k; k = g.shift();)
                    if (k.getDtd().p) { g = { element: k, remaining: g };
                        break a }
                g = null }
            if (!g) return 0;
            if ((k = CKEDITOR.filter.instances[g.element.data("cke-filter")]) && !k.check(c)) return b(a,
                c, f, g.remaining);c = new CKEDITOR.dom.range(g.element);c.selectNodeContents(g.element);c = c.createIterator();c.enlargeBr = a.enlargeBr;c.enforceRealBlocks = a.enforceRealBlocks;c.activeFilter = c.filter = k;a._.nestedEditable = { element: g.element, container: f, remaining: g.remaining, iterator: c };
            return 1
        }
        ...
        a.prototype = {
            getNextParagraph: function(a) {
                ...
                if (!this._.started) {
                    ...
                    k = q.startPath();
                    var w = q.endPath(),
                        H = !q.collapsed && c(q, k.block),
                        t = !q.collapsed && c(q, w.block, 1);
                ...
                for (this._.nextNode = null; w;) {
                    var H = 0,
                        t = w.hasAscendant("pre"),
                        v = w.type != CKEDITOR.NODE_ELEMENT,
                        h = 0;
                    if (v) w.type == CKEDITOR.NODE_TEXT && f.test(w.getText()) && (v = 0);
                    else {
                        var p = w.getName();
                        if (CKEDITOR.dtd.$block[p] && "false" == w.getAttribute("contenteditable")) { d = w;
                            b(this, a, d);
                            break } else if (w.isBlockBoundary(this.forceBrBreak && !t && { br: 1 })) {
                            if ("br" == p) v = 1;
                            else if (!k && !w.getChildCount() && "hr" != p) { d = w;
                                r = w.equals(q);
                                break }
                            k && (k.setEndAt(w, CKEDITOR.POSITION_BEFORE_START), "br" != p && (this._.nextNode = w));
                            H = 1 } else {
                            if (w.getFirst()) { k || (k = this.range.clone(), k.setStartAt(w, CKEDITOR.POSITION_BEFORE_START));
                                w = w.getFirst();
                                continue }
                            v = 1 }
                    }
                    ...
                    r = (!H || v) && w.equals(q);
                    if (k && !H)
                        for (; !w.getNext(l) && !r;) { p = w.getParent();
                            if (p.isBlockBoundary(this.forceBrBreak && !t && { br: 1 })) { H = 1;
                                v = 0;
                                r || p.equals(q);
    ...
    (function() {
        function a(a, b, c, d, f) {
            ...
            for (d = a.length; c < d; ++c) {
                ...
                if (!0 === h.elements ||
                    null === h.elements) f[p ? "unshift" : "push"](h);
                else
                    for (E in n = h.elements, delete h.elements, n)
                        if (b[E]) b[E][p ? "unshift" : "push"](h);
                        else b[E] = [h]
            }
        }
        ...
        function e(a) {
            var b, c, d, h, p = {},
                f = 1;
            for (a = Y(a); b = a.match(B);)(c = b[2]) ? (d = A(c, "styles"), h = A(c, "attrs"), c = A(c, "classes")) : d = h = c = null, p["$" + f++] = { elements: b[1], classes: c, styles: d, attributes: h }, a = a.slice(b[0].length);
            return p }
        ...
        function x(a, b, h, f) {
            ...
            if (f.doCallbacks && a.elementCallbacks) { a: { e = a.elementCallbacks;
                    for (var g = 0, v = e.length, y; g < v; ++g)
                        if (y = e[g](b)) { e = y;
                            break a }
                    e = void 0 }
                if (e) return e }
            if (f.doTransform && (e = a._.transformations[b.name])) { r(b);
            ...
            if (f.doFilter) {
                a: {
                    ...
                    y = f.skipRequired;
                    var k = { valid: !1, validAttributes: {}, validClasses: {}, validStyles: {}, allAttributes: !1, allClasses: !1, allStyles: !1, hadInvalidAttribute: !1, hadInvalidClass: !1, hadInvalidStyle: !1 },
                        B, z;
                    if (a || e) { r(b);
                        if (g)
                            for (B = 0, z = g.length; B < z; ++B)
                                if (!1 === c(g[B], b, k)) { a = null;
                                    break a }
                        if (v)
                            for (B = 0, z = v.length; B < z; ++B) c(v[B], b, k);
                        if (a)
                            for (B = 0, z = a.length; B < z; ++B) d(a[B], b, k, y);
                        if (e)
                            for (B = 0, z = e.length; B < z; ++B) d(e[B], b, k, y);
                        a = k } else a = null
                }
                if (!a || !a.valid) return h.push(b), 1;z = a.validAttributes;
                var E = a.validStyles;
                e = a.validClasses;
                var g = b.attributes,
                    J = b.styles,
                    v = b.classes;y = b.classBackup;
                var l = b.styleBackup,
                    G, I, C = [],
                    k = [],
                    m = /^data-cke-/;B = !1;delete g.style;delete g["class"];delete b.classBackup;delete b.styleBackup;
                if (!a.allAttributes)
                    for (G in g) z[G] || (m.test(G) ? G == (I = G.replace(/^data-cke-saved-/, "")) || z[I] || (delete g[G], B = !0) : (delete g[G], B = !0));
                if (!a.allStyles || a.hadInvalidStyle) {
                    for (G in J) a.allStyles || E[G] ? C.push(G + ":" + J[G]) : B = !0;
                    C.length && (g.style = C.sort().join("; ")) } else l && (g.style = l);
                if (!a.allClasses ||
                    a.hadInvalidClass) {
                    for (G = 0; G < v.length; ++G)(a.allClasses || e[v[G]]) && k.push(v[G]);
                    k.length && (g["class"] = k.sort().join(" "));
                    y && k.length < y.split(/\s+/).length && (B = !0) } else y && (g["class"] = y);B && (n = 1);
        ...
        function h(a, b, c) {
            var d = a.name;
            if (E.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(t()) : (a.parent && c.push({ check: "it", el: a.parent }), a.remove());
            else if (E.$block[d] || "tr" == d)
                if ("br" == b) a.previous && !v(a.previous) && (b = t(), b.insertBefore(a)), a.next && !v(a.next) && (b = t(), b.insertAfter(a)), a.replaceWithChildren();
                else {
                    var d = a.children,
                        h;
                    b: { h = E[b];
                        for (var p = 0, f = d.length, n; p < f; ++p)
                            if (n = d[p], n.type == CKEDITOR.NODE_ELEMENT && !h[n.name]) { h = !1;
                                break b }
                        h = !0 }
                    if (h) a.name = b, a.attributes = {}, c.push({ check: "parent-down", el: a });
                    else { h = a.parent;
                        for (var p = h.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == h.name, e, g, f = d.length; 0 < f;) n = d[--f], p && (n.type == CKEDITOR.NODE_TEXT || n.type == CKEDITOR.NODE_ELEMENT && E.$inline[n.name]) ? (e || (e = new CKEDITOR.htmlParser.element(b), e.insertAfter(a), c.push({ check: "parent-down", el: e })), e.add(n, 0)) : (e = null, g = E[h.name] || E.span, n.insertAfter(a), h.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || n.type != CKEDITOR.NODE_ELEMENT || g[n.name] || c.push({ check: "el-up", el: n }));
                        a.remove() }
                }
        ...
        function p(a, b, c) {
            ...
            for (d = 0; d < c.length; ++d)
                if (h = c[d], !(h.check && !a.check(h.check, !1) || h.left && !h.left(b))) { h.right(b, G);
                    break } }
        ...
        function n(a, b) {
            ...
            for (p in d)
                if ("class" == p)
                    for (c = d[p].split(/\s+/), n = a.classes.join("|"); e = c.pop();) {
                        if (-1 == n.indexOf(e)) return !1 } else if (a.attributes[p] != d[p]) return !1;
            for (f in h)
                if (a.styles[f] !=
                    h[f]) return !1;
            return !0
        ...
        CKEDITOR.filter.prototype = {
            ...
            applyTo: function(a, b, c, d) {
                ...
                a.forEach(function(a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-"))
                            if (e = x(p, a, f, F), e & 1) g = !0;
                            else if (e & 2) return !1 } else if (a.type == CKEDITOR.NODE_COMMENT && a.value.match(/^\{cke_protected\}(?!\{C\})/)) {
                        var c;
                        a: {
                            ...
                            if (n)
                                for (v = 0; v < n.length; ++v)
                                    if ((y = d.match(n[v])) && y[0].length == d.length) {
                                        c = !0;
                                        break a
                                    }
                ...
                for (; v = a.pop();)
                    if (c = v.el, c.parent) switch (y = E[c.parent.name] || E.span, v.check) {
                        case "it":
            ...
            disallow: function(b) {
                if (!g(this, b, !0)) return !1; "string" == typeof b && (b = e(b));
                ...
                if (!this.disabled && a) {
                    ...
                    for (h = 0; h < a.length; ++h) {
                        ...
                        for (f = 0; f < b.length; ++f) n = b[f], "string" == typeof n ? (n = n.split(/\s*:\s*/), e = n[0], g = null, v = n[1]) : (e = n.check, g = n.left, v = n.right), p || (p = n, p = p.element ? p.element : e ? e.match(/^([a-z0-9]+)/i)[0] :
                            p.left.getDefinition().element), g instanceof CKEDITOR.style && (g = z(g)), c.push({ check: e == p ? null : e, left: g, right: "string" == typeof v ? J(v) : v });
                        b = p;
                        d[b] || (d[b] = []);
                        d[b].push(c)
                    }
            ...
            check: function(a, b, c) {
                ...
                if ("string" == typeof a) {
                    ...
                    h = d
                } else d = a.getDefinition(), h = d.styles, n = d.attributes || {}, h && !CKEDITOR.tools.isEmpty(h) ? (h = C(h), n.style = CKEDITOR.tools.writeCssText(h, !0)) : h = {}, h = { name: d.element, attributes: n, classes: n["class"] ? n["class"].split(/\s+/) : [], styles: h, children: [] };
                var n = CKEDITOR.tools.clone(h),
                    g = [],
                    v;
        ...
        var O = { styles: 1, attributes: 1, classes: 1 },
            N = { styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses" },
        ...
        G = CKEDITOR.filter.transformationsTools = {
            ...
            transform: function(a, b) {
                if ("string" == typeof b) a.name = b;
                    ...
                    for (p in h)
                        if ("class" == p)
                            for (c = a.classes.join("|"), f = h[p].split(/\s+/); e = f.pop();) - 1 == c.indexOf(e) && a.classes.push(e);
                            ...
                            if (a[b]) A(b, !0);
                                ...
                                if (!(1 < f.length)) {
                                    ...
                                    c && (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat) ? e.$.onreadystatechange = function() {
                                        if ("loaded" == e.$.readyState || "complete" == e.$.readyState) e.$.onreadystatechange = null, r(b, !0) } : (e.$.onload = function() { setTimeout(function() { r(b, !0) }, 0) }, e.$.onerror = function() { r(b, !1) }));
        ...
        load: function(a, d, b) {
            ...
            CKEDITOR.scriptLoader.load(g, function(a, f) {
                ...
                for (var e = 0; e < a.length; e++)
                    for (var g = k[a[e]], q = 0; q < g.length; q++) {
                        var w = g[q];
                        l[w] = this.get(w);
                        c[w] = 1 }
                d.call(b, l) }, this)
                ...
                k = function(b) {
                    a.call(this, b, function(a) {
                        ...
                        for (e in a) {
                            ...
                            if (!d[e]) {
                                if (l.icons)
                                    for (var x = l.icons.split(","), D = x.length; D--;) CKEDITOR.skin.addIcon(x[D], l.path + "icons/" + (CKEDITOR.env.hidpi && l.hidpi ? "hidpi/" : "") + x[D] + ".png");
                                d[e] = 1 }
                            if (r)
                                for (r.split && (r = r.split(",")), l = 0; l < r.length; l++) g[r[l]] || b.push(r[l]) }
    ...
    (function() {
        ...
        function d() { do var a = "editor" + ++x; while (CKEDITOR.instances[a]);
            return a }
        ...
        function m(a) { CKEDITOR.skin.loadPart("editor", function() { u(a) }) }
        ...
        function e(a) { a.getStylesSet(function(b) { a.once("loaded", function() { a.fire("stylesSet", { styles: b }) }, null, null, 1);
                A(a) }) }
        ...
        function A(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function(c) {
                ...
                for (var e in c) {
                    ...
                    if (l && (m = l.match(p)))
                        for (; l = m.pop();) CKEDITOR.error("editor-plugin-required", { plugin: l.replace(",", ""), requiredBy: e });
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            ...
            _attachToForm: function() {
                ...
                d.is("textarea") && f && (f.on("submit", a), b(f.$.submit) && (f.$.submit = CKEDITOR.tools.override(f.$.submit, function(b) {
                    return function() { a();
                        b.apply ? b.apply(this) : b() } })), c.on("destroy", function() { f.removeListener("submit", a) }))
            },
            destroy: function(a) {
        ...
        CKEDITOR.htmlParser.prototype = {
            ...
            parse: function(b) {
                for (var c, f, g = 0, k; c = this._.htmlPartsRegex.exec(b);) {
                    ...
                    if (f = c[1])
                        if (f = f.toLowerCase(), k && CKEDITOR.dtd.$cdata[f] && (this.onCDATA(k.join("")), k = null), !k) { this.onTagClose(f);
                            continue }
                    if (k) k.push(c[0]);
                    else if (f = c[3]) {
                        if (f = f.toLowerCase(), !/="/.test(f)) {
                            ...
                            this.onTagOpen(f, l, c);!k && CKEDITOR.dtd.$cdata[f] && (k = []) } } else if (f = c[2]) this.onComment(f)
                }
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function(g, k, l) {
                ...
                D.onTagOpen = function(f, n, e, g) {
                    ...
                    if (a(n)) w.push(n);
                        ...
                        if ("pre" == f) h = !0;
                            ...
                            if ("br" == f && h) { t.add(new CKEDITOR.htmlParser.text("\n"));
                                return } "textarea" == f && (v = !0) }
                        if ("br" == f) H.push(n);
                        else {
                            for (; !(g = (e = t.name) ? CKEDITOR.dtd[e] || (t._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, n.isUnknown || t.isUnknown || g[f]);)
                                if (t.isOptionalClose) D.onTagClose(e);
                                else if (f in b && e in b) e = t.children, (e = e[e.length - 1]) && "li" == e.name || A(e = new CKEDITOR.htmlParser.element("li"), t), !n.returnPoint && (n.returnPoint = t), t = e;
                            else if (f in CKEDITOR.dtd.$listItem &&
                                !x(f, e)) D.onTagOpen("li" == f ? "ul" : "dl", {}, 0, 1);
                            else if (e in d && !x(f, e)) !n.returnPoint && (n.returnPoint = t), t = t.parent;
                            else if (e in CKEDITOR.dtd.$inline && w.unshift(t), t.parent) A(t, t.parent, 1);
                            else { n.isOrphan = 1;
                                break }
                            m(f);
                            u();
                ...
                D.onText = function(a) {
                    ...
                    if (!v && !e["#"] && b in d) D.onTagOpen(f[b] || ""), D.onText(a);
                    else { u();
                        m();
                        h || v || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
    ...
    (function() {
        ...
        a.prototype = {
            ...
            addMany: function(a,
                c, d) {
                for (var g = [this.findIndex(c), 0], k = 0, l = a.length; k < l; k++) g.push({ value: a[k], priority: c, options: d });
            ...
            exec: function(a, c) {
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    ...
                    m, u, e, A;
                for (A = 0; A < l; A++)
                    if (d && (m = c.type, u = c.name), e = k[A], !(a.nonEditable && !e.options.applyToAll ||
                            a.nestedEditable && e.options.excludeNestedEditable)) { e = e.value.apply(null, g);
    ...
    (function() {
                ...
                return function(h) {
                    if (h.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var f = [],
                            ...
                            v, F;
                        if (n)
                            for (p(n, 1) && f.push(n); n;) g(n) && (v = c(n)) && p(v) && ((F = c(v)) && !g(F) ? f.push(v) : (e(y).insertAfter(v), v.remove())), n = n.previous;
            ...
            return a.replace(J,
                function(a, b, c) {
                    return "\x3c" + b + c.replace(E, function(a, b) {
                        return C.test(b) && -1 == c.indexOf("data-cke-saved-" + b) ? " data-cke-saved-" + a + " data-cke-" + CKEDITOR.rnd + "-" + a : a }) + "\x3e" })
        }

        function e(a, b) {
            return a.replace(b, function(a, b, c) { 0 === a.indexOf("\x3ctextarea") && (a = b + x(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e");
        ...
        function q(a, b) {
            ...
            for (var e = 0; e < d.length; e++) a = a.replace(d[e], function(a) { a = a.replace(f, function(a, b, d) {
                    return c[d] });
        ...
        CKEDITOR.htmlDataProcessor = function(b) {
            ...
            b.on("toHtml", function(a) { a.data.dataValue.filterChildren(f.dataFilter, !0) }, null, null, 10);
            b.on("toHtml", function(a) {
                a = a.data;
                var b = a.dataValue,
            ...
            b.on("toDataFormat", function(a) { a.data.dataValue.filterChildren(f.htmlFilter, !0) }, null, null, 10);
            b.on("toDataFormat", function(a) {
        ...
        var w = /(?:&nbsp;|\xa0)$/,
            H = "{cke_protected}",
            t = CKEDITOR.dtd,
            v = "caption colgroup col thead tfoot tbody".split(" "),
                ...
                elements: {
                    ...
                    table: function(a) {
                        a.children.slice(0).sort(function(a, b) {
                            var c, d;
                            a.type == CKEDITOR.NODE_ELEMENT && b.type == a.type && (c = CKEDITOR.tools.indexOf(v, a.name), d = CKEDITOR.tools.indexOf(v, b.name)); - 1 < c && -1 < d && c != d || (c = a.parent ? a.getIndex() : -1, d = b.parent ? b.getIndex() : -1);
                            return c > d ?
                                1 : -1
                        })
                    },
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            filter: function(a, b) {
                ...
                for (m in k) {
                    for (l = k[m];;)
                        if (u = a.onAttributeName(b, m))
                            if (u != m) delete k[m], m = u;
                            else break;
                    else { delete k[m];
                        break }
    ...
    (function() {
        ...
        CKEDITOR.inlineAll = function() {
            ...
            for (b in CKEDITOR.dtd.$editable)
                for (var c = CKEDITOR.document.getElementsByTag(b), f = 0, g = c.count(); f < g; f++) a = c.getItem(f), "true" == a.getAttribute("contenteditable") && (d = { element: a, config: {} }, !1 !== CKEDITOR.fire("inline", d) && CKEDITOR.inline(a, d.config)) };
        ...
        CKEDITOR.editor.prototype.setMode = function(a, b) {
            ...
            if (a != d.mode && k && k[a]) {
                ...
                if (d.mode) {
                    ...
                    d._.previousModeData = m = d.getData(1); "source" == d.mode && k == m && (d.fire("lockSnapshot", { forceUpdate: !0 }), u = 1);
    ...
    (function() {
        function a(a) {
            ...
            if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller)
                if (f = d(f, e)) f.appendBogus(), l = CKEDITOR.env.ie;
            k(b, e.block, n) && g.collapsed && !g.getCommonAncestor().isReadOnly() && (e = g.clone(), e.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), n = new CKEDITOR.dom.walker(e), n.guard = function(a) {
                    return !c(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly() }, !n.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) &&
            ...
            proto: {
                ...
                insertElement: function(a, b) {
                    ...
                    this.insertElementIntoRange(a, b) && (b.moveToPosition(a,
                        ...
                        return c(a) && !x(a) })) && f.type == CKEDITOR.NODE_ELEMENT && f.is(CKEDITOR.dtd.$block) ? f.getDtd()["#"] ? b.moveToElementEditStart(f) : b.moveToElementEditEnd(a) : f || e == CKEDITOR.ENTER_BR || (f = b.fixBlock(!0, e == CKEDITOR.ENTER_DIV ? "div" : "p"), b.moveToElementEditStart(f))));
                    d.selectRanges([b]);
                    m(this)
                },
                ...
                fixInitialSelection: function() {
                    function a() {
                        ...
                        a: if (d.anchorNode && d.anchorNode == c.$) h = !0;
                                ...
                                if (CKEDITOR.env.webkit && (h = c.getDocument().getActive()) && h.equals(c) && !d.anchorNode) { h = !0;
                                    break a }
                                h = void 0 }
                ...
                extractHtmlFromRange: function(a, b) {
                    ...
                    if (b) { c = a.startPath();
                        if (d = a.checkStartOfBlock() && a.checkEndOfBlock() && c.block && !a.root.equals(c.block)) { a: {
                                ...
                                d = !1 }
                            d = !d }
                        d && (a.moveToPosition(c.block, CKEDITOR.POSITION_BEFORE_START), c.block.remove()) } else c.autoParagraph(this.editor, a), r(a.startContainer) && a.startContainer.appendBogus();
                ...
                setup: function() {
                    ...
                    if (!this.is("textarea")) {
                        ...
                        a.blockless && CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller && this.attachListener(this, "keyup",
                            function(b) { b.data.getKeystroke() in l && !this.getFirst(c) && (this.appendBogus(), b = a.createRange(), b.moveToPosition(this, CKEDITOR.POSITION_AFTER_START), b.select()) });
                        ...
                        CKEDITOR.env.webkit && (this.attachListener(this,
                            "click",
                            function(a) { a.data.getTarget().is("input", "select") && a.data.preventDefault() }), this.attachListener(this, "mouseup", function(a) { a.data.getTarget().is("input", "textarea") && a.data.preventDefault() }));
        ...
        q = function() {
            ...
            function b(c, d) {
                ...
                f = d.range.startPath();
                for (var k = E[k.getName()], y = 0, l = c.getChildren(), z = l.count(), J = -1, m = -1, q = 0, u = f.contains(E.$list); y < z; ++y) f = l.getItem(y), a(f) ? (n = f.getName(), u && n in CKEDITOR.dtd.$list ? g = g.concat(b(f, d)) : (p = !!k[n], "br" != n || !f.data("cke-eol") || y && y != z - 1 || (q = (e = y ? g[y - 1].node : l.getItem(y + 1)) && (!a(e) || !e.is("br")), e = e && a(e) && E.$block[e.getName()]), -1 != J || p || (J = y), p || (m = y), g.push({
                    isElement: 1,
                    isLineBreak: q,
                    ...
                    name: n,
                    allowed: p
                }), e = q = 0)) : g.push({ isElement: 0, node: f, allowed: 1 }); - 1 < J && (g[J].firstNotAllowed = 1); - 1 < m && (g[m].lastNotAllowed = 1);
                return g
            }
            ...
            var E = CKEDITOR.dtd,
                ...
                q = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1 },
                u = CKEDITOR.tools.extend({}, E.$inline);
            delete u.br;
            return function(m, C, B, I) {
                ...
                if (!I.checkReadOnly()) {
                    var G = (new CKEDITOR.dom.elementPath(I.startContainer, I.root)).blockLimit ||
                        I.root;
                    m = { type: C, dontFilter: K, editable: m, editor: F, range: I, blockLimit: G, mergeCandidates: [], zombies: [] };
                    C = m.range;
                    I = m.mergeCandidates;
                    var L, r;
                    ...
                    if (!C.collapsed) {
                        var F = G.block || G.blockLimit,
                            w = C.getCommonAncestor();
                        F && !F.equals(w) &&
                            !F.contains(w) && C.checkEndOfBlock() && m.zombies.push(F);
                        C.deleteContents()
                    }
                    for (;
                        (r = f(C)) && a(r) && r.isBlockBoundary() && K.contains(r);) C.moveToPosition(r, CKEDITOR.POSITION_BEFORE_END);
                    ...
                    if (L = B) {
                        L = m.range;
                        if ("text" == m.type && m.inlineStylesRoot) { r = m.inlineStylesPeak;
                        ...
                        if ((A = L.startPath().block) && (1 != A.getChildCount() || !A.getBogus())) a: {
                            ...
                            if (1 == r.getChildCount() && a(x = r.getFirst()) && x.is(q) && !x.hasAttribute("contenteditable")) {
                                ...
                                L = 0;
                                for (I = A.count(); L < I; L++)
                                    if (C = A.getItem(L), !C.is(u)) break a;
                    ...
                    if (L) {
                        ...
                        for (J(C, x); I < C.length; I++) {
                            ...
                            if (t = G.isLineBreak) {
                                ...
                                var T = void 0,
                                    aa = void 0;
                                G.hasBlockSibling ? t = 1 : (T = t.startContainer.getAscendant(E.$block, 1)) && T.is({ div: 1, p: 1 }) ? (aa =
                            ...
                            if (t) B = 0 < I;
                                ...
                                if (F && G.isElement) { t = x.startContainer;
                                    for (R = null; t && !E[t.getName()][G.name];) {
                                        if (t.equals(r)) { t = null;
                                            break }
                                        R = t;
                                        t = t.getParent() }
                                    if (t) R && (W = x.splitElement(R), m.zombies.push(W), m.zombies.push(R));
                                    else { R = r.getName();
                                        X = !I;
                                        t = I == C.length - 1;
                                        R = d(G.node, R);
                    ...
                    if (!m.dontMoveCaret) {
                        for (M = f(D); M && a(M) && !M.is(E.$empty);) {
                            if (M.isBlockBoundary()) D.moveToPosition(M, CKEDITOR.POSITION_BEFORE_END);
                                ...
                                if (e(M) && M.getHtml().match(/(\s|&nbsp;)$/g)) { S = null;
                                    break }
                                S = D.clone();
        ...
        w = function() {
            ...
            return function(d) {
                ...
                e || (e = f);
                e.is("table") ? (d.setStartAt(e, CKEDITOR.POSITION_BEFORE_START), d.collapse(!0), e.remove()) : (e.is({ tbody: 1, thead: 1, tfoot: 1 }) && (e = b(e, "tr", g)), e.is("tr") && (e = b(e, e.getParent().is("thead") ? "th" : "td", g)), (f = e.getBogus()) && f.remove(), d.moveToPosition(e, g ? CKEDITOR.POSITION_AFTER_START :
                    CKEDITOR.POSITION_BEFORE_END))
            }
        }();
        H = {
            ...
            bogus: { exclude: function(a) {
                    var b = a.range.getBoundaryNodes(),
                        c = b.startNode,
                        b = b.endNode;!b || !x(b) || c && c.equals(b) || a.range.setEndBefore(b) } },
            tree: {
                ...
                table: function() {
                    function a(c) {
                        ...
                        h.guard = function(a, h) {
                            ...
                            else if (!h && n && a.equals(n)) f = c.clone(), f.setStartAt(n, CKEDITOR.POSITION_AFTER_START),
                                e.push(f);
                            else {
    ...
    (function() {
        ...
        var A = "function" != typeof window.getSelection,
            r = 1,
            x = CKEDITOR.tools.repeat("​", 7),
            D = new RegExp(x + "( )?", "g"),
            q, w, H = CKEDITOR.dom.walker.invisible(1),
            t = function() {
                function a(b) {
                    return function(a) {
        ...
        CKEDITOR.on("instanceCreated", function(b) {
            ...
            e.on("contentDom", function() {
                function b() { B = new CKEDITOR.dom.selection(e.getSelection());
                    B.lock() }

                function c() { h.removeListener("mouseup", c);
                ...
                g.attachListener(g,
                    "mousedown",
                    function() { q = 0 });
                if (CKEDITOR.env.ie || m) A ? g.attachListener(g, "beforedeactivate", b, null, null, -1) : g.attachListener(e, "selectionCheck", b, null, null, -1), g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function() { e.lockSelection(B);
                    ...
                    if ("BackCompat" != f.$.compatMode) {
                        if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) {
                            ...
                            l.on("mousedown", function(a) {
                                ...
                                a = a.data;
                                if (a.getTarget().is("html") && a.$.y < l.$.clientHeight && a.$.x < l.$.clientWidth) { F = p.$.createTextRange();
                                    try { F.moveToPoint(a.$.clientX, a.$.clientY) } catch (d) {}
                                    K = F.duplicate();
                                    l.on("mousemove", b);
                                    h.on("mouseup", c);
                                    l.on("mouseup", c) }
                ...
                if (m && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
                    var G;
                    g.attachListener(g, "mousedown", function() { G = 1 });
                    g.attachListener(f.getDocumentElement(), "mouseup", function() { G && d.call(e);
                        G = 0 }) } else g.attachListener(CKEDITOR.env.ie ? g : f.getDocumentElement(), "mouseup", d, e);
        ...
        var v = { img: 1, hr: 1, li: 1, table: 1, tr: 1, td: 1, th: 1, embed: 1, object: 1, ol: 1, ul: 1, a: 1, input: 1, form: 1, select: 1, textarea: 1, button: 1, fieldset: 1, thead: 1, tfoot: 1 };
        ...
        CKEDITOR.dom.selection.prototype = {
            ...
            getRanges: function() {
                var a = A ? function() {
                    ...
                    var b = function(b, c) {
                        ...
                        for (var e = d.children, f, h, g = b.duplicate(), k = 0, l = e.length - 1, B = -1, n, m; k <= l;)
                            if (B = Math.floor((k + l) / 2), f = e[B], g.moveToElementText(f), n = g.compareEndPoints("StartToStart", b), 0 < n) l = B - 1;
                            else if (0 > n) k = B + 1;
            ...
            getSelectedElement: function() {
                ...
                var b = this,
                    c = CKEDITOR.tools.tryThese(function() {
                        ...
                        for (var a = b.getRanges()[0].clone(), c, d, e = 2; e && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && v[c.getName()] && (d = c)); e--) a.shrink(CKEDITOR.SHRINK_ELEMENT);
                        return d && d.$ });
            ...
            getSelectedText: function() {
                ...
                var b = this.getNative(),
                    b = A ? "Control" == b.type ? "" : b.createRange().text : b.toString();
                        ...
                        if (l) this.fake(l);
                            ...
                            if (A) {
                                ...
                                if ((c = l.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT &&
                                    c.getName() in v && (!c.is("a") || !c.getText())) try { t = c.$.createControlRange();
                                    t.addElement(c.$);
                                    t.select();
                                    return } catch (x) {}
                                ...
                                for (t = 0; t < a.length; t++) {
                                    if (t < a.length - 1 && (u = a[t], r = a[t + 1], m = u.clone(), m.setStart(u.endContainer, u.endOffset), m.setEnd(r.startContainer, r.startOffset), !m.collapsed && (m.shrink(CKEDITOR.NODE_ELEMENT, !0), l = m.getCommonAncestor(), m = m.getEnclosedNode(), l.isReadOnly() || m && m.isReadOnly()))) { r.setStart(u.startContainer, u.startOffset);
                                        a.splice(t--, 1);
                                        continue }
                                    l = a[t];
                                    ...
                                    try { r.setEnd(l.endContainer.$, l.endOffset) } catch (B) {
                                        if (0 <= B.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) l.collapse(1), r.setEnd(l.endContainer.$, l.endOffset);
                                        else throw B; }
                                    e.addRange(r)
                                }
                            }
            ...
            removeAllRanges: function() {
                if (this.getType() != CKEDITOR.SELECTION_NONE) {
                    var a = this.getNative();
                    try { a && a[A ? "empty" : "removeAllRanges"]() } catch (b) {}
                    this.reset() } }
        }
    })();
    "use strict";
    ...
    (function() {
                ...
                for (r.getPosition(u) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
                    ...
                    if (r.equals(u)) r = null, l = !0;
                        ...
                        var x = r.type == CKEDITOR.NODE_ELEMENT ? r.getName() : null,
                            v = x && "false" == r.getAttribute("contentEditable"),
                            A = x &&
                            r.getAttribute("data-nostyle");
                        if (x && r.data("cke-bookmark")) { r = r.getNextSourceNode(!0);
                            continue }
                        if (v && m && CKEDITOR.dtd.$block[x])
                            for (var w = r, y = f(w), z = void 0, C = y.length, E = 0, w = C && new CKEDITOR.dom.range(w.getDocument()); E < C; ++E) {
                                var z = y[E],
                                    J = CKEDITOR.filter.instances[z.data("cke-filter")];
                                if (J ? J.check(this) : 1) w.selectNodeContents(z), b.call(this, w) }
                        y = x ? !n[x] || A ? 0 : v && !m ? 0 : d(r, u, h, O) : 1;
                        if (y)
                            if (z = r.getParent(), y = h, C = g, E = k, !z || !(z.getDtd() || CKEDITOR.dtd.span)[C] && !E || y.parentRule && !y.parentRule(z)) l = !0;
                            else {
                                if (t ||
                                    ...
                                    for (var x = r, P;
                                        (l = !x.getNext(Y)) && (P = x.getParent(), n[P.getName()]) && d(P, q, h, N);) x = P;
                                    t.setEndAfter(x) }
                            }
                        else l = !0;
        ...
        function l(a) {
            ...
            for (var d, e = a.document, f; d = c.getNextParagraph();) !d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = H(this, e, d), u(d, f));
            a.moveToBookmark(b) }
        ...
        function D(a) {
            for (var b = h(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;) d = c.getItem(e), d.isReadOnly() || x.call(this, d, !0);
            for (var f in b)
                if (f != this.element)
            ...
            if (!a.hasAttributes() || b)
                if (CKEDITOR.dtd.$block[a.getName()]) {
                    var c = a.getPrevious(P),
                        d = a.getNext(P);!c || c.type != CKEDITOR.NODE_TEXT && c.isBlockBoundary({ br: 1 }) || a.append("br", 1);!d || d.type != CKEDITOR.NODE_TEXT && d.isBlockBoundary({ br: 1 }) || a.append("br");
        ...
        var z = { address: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, section: 1, header: 1, footer: 1, nav: 1, article: 1, aside: 1, figure: 1, dialog: 1, hgroup: 1, time: 1, meter: 1, menu: 1, command: 1, keygen: 1, output: 1, progress: 1, details: 1, datagrid: 1, datalist: 1 },
            J = { a: 1, blockquote: 1, embed: 1, hr: 1, img: 1, li: 1, object: 1, ol: 1, table: 1, td: 1, tr: 1, th: 1, ul: 1, dl: 1, dt: 1, dd: 1, form: 1, audio: 1, video: 1 },
            E = /\s*(?:;\s*|$)/,
            C = /#\((.+?)\)/g,
            Y = CKEDITOR.dom.walker.bookmark(0,
                1),
        ...
        CKEDITOR.style.prototype = {
            ...
            removeFromRange: function(a) { this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? c : this.type == CKEDITOR.STYLE_BLOCK ? m : this.type == CKEDITOR.STYLE_OBJECT ? k : null;
        ...
        CKEDITOR.style.getStyleText = function(a) {
            ...
            for (var e in b) {
                var f = b[e],
                    g = (e + ":" + f).replace(E, ";"); "inherit" == f ? d += g : c += g }
            ...
            do
                if (m.type == CKEDITOR.NODE_ELEMENT) {
                    ...
                    if (!k && (u = m.getName(),
                        ...
                        if (u = !g && "div" == u) { a: { u = m.getChildren();
                                for (var e = 0, A = u.count(); e < A; e++) {
                                    var r = u.getItem(e);
                                    if (r.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[r.getName()]) { u = !0;
                                        break a } }
                                u = !1 }
                            u = !u }
                        u ? g = m : k = m }
    ...
    (function() {
        ...
        function d(b) {
            ...
            if (c)
                for (var c = c.split(",").sort(function(a, b) {
                        return a > b ? -1 : 1 }), f = 0, g; f < c.length; f++)
                    if (g = c[f], d.ie && (g.replace(/^ie/, "") == d.version || d.quirks && "iequirks" == g) && (g = "ie"), d[g]) { b += "_" + c[f];
                        break }
        ...
        function f(a, b, c) {
            ...
            for (var k = 0; k < a.length; k++)
                if (CKEDITOR.env.webkit)
                    for (f = 0; f < b.length; f++) { g = b[f][1];
                        for (d = 0; d < c.length; d++) g = g.replace(c[d][0], c[d][1]);
                        a[k].$.sheet.addRule(b[f][0], g) } else {
                        g = b;
                        for (d = 0; d < c.length; d++) g = g.replace(c[d][0], c[d][1]);
    ...
    */
    ...
    (function() {
        ...
        function y(b) {
            ...
            function d() {
                return {
                    ...
                    exec: function(b, a) {
                        ...
                        "string" == typeof a ? c({ dataValue: a, method: "paste", dataTransfer: n.initPasteDataTransfer() }, 1) : b.getClipboardData(c)
                    }
                }
            }
            ...
            function l(a, d) {
                ...
                if (!c.getById("cke_pastebin")) {
                    ...
                    setTimeout(function() { CKEDITOR.env.webkit && (CKEDITOR.document.getBody().$.scrollTop = l);
                        q && q.removeListener();
            ...
            function q(a) {
                if ("wysiwyg" == b.mode) switch (a.data.keyCode) {
                    ...
                    case CKEDITOR.SHIFT + 46:
                        b.fire("saveSnapshot"), setTimeout(function() { b.fire("saveSnapshot") },
                            50)
                }
            }
            ...
            (function() {
                b.on("key", q);
                b.on("contentDom", a);
                b.on("selectionChange", function(b) { w = b.data.selection.getRanges()[0].checkReadOnly();
                    t() });
                b.contextMenu && b.contextMenu.addListener(function(b,
                    a) { w = a.getRanges()[0].checkReadOnly();
            ...
            b.getClipboardData = function(a, d) {
                ...
                !1 === z() && (b.removeListener("paste", c), q && b.fire("pasteDialog", f) ? (b.on("pasteDialogCommit", e), b.on("dialogHide", function(a) {
                    ...
                    a.data.removeListener("pasteDialogCommit",
                        e);
                    setTimeout(function() { k || d(null) }, 10)
                })) : d(null))
            }
        }
        ...
        function x(b, a, c) { a = CKEDITOR.htmlParser.fragment.fromHtml(a);
        ...
        function F(b) {
            ...
            b.on("contentDom", function() {
                ...
                f.attachListener(b, "dragstart", function() {
                    ...
                    CKEDITOR.env.ie && 10 > CKEDITOR.env.version && (a.dragStartContainerChildCount = d ? g(d.startContainer) : null, a.dragEndContainerChildCount = d ? g(d.endContainer) : null) }, null, null, 100);
                ...
                f.attachListener(b, "drop", function(e) {
                    if (e = e.data) {
                        var f = e.dropRange,
                            g = e.dragRange,
                            h = e.dataTransfer;
                        h.getTransferType(b) == CKEDITOR.DATA_TRANSFER_INTERNAL ? setTimeout(function() { a.internalDrop(g, f, h, b) }, 0) : h.getTransferType(b) == CKEDITOR.DATA_TRANSFER_CROSS_EDITORS ? c(g, f, h) : d(f, h) } }, null, null, 9999)
            })
        }
                ...
                b.on("paste", function(a) {
                    var b = a.data.dataValue,
                        c = CKEDITOR.dtd.$block; - 1 < b.indexOf("Apple-") && (b = b.replace(/<span class="Apple-converted-space">&nbsp;<\/span>/gi, " "), "html" != a.data.type && (b = b.replace(/<span class="Apple-tab-span"[^>]*>([^<]*)<\/span>/gi, function(a, b) {
                            return b.replace(/\t/g, "\x26nbsp;\x26nbsp; \x26nbsp;") })), -1 < b.indexOf('\x3cbr class\x3d"Apple-interchange-newline"\x3e') &&
        ...
        CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
            getData: function(b) { b = this._.normalizeType(b);
                var a = this._.data[b];
                if (void 0 === a || null === a || "" === a) try { a = this.$.getData(b) } catch (c) {}
                if (void 0 === a || null === a || "" === a) a = ""; "text/html" == b ? (a = a.replace(this._.metaRegExp, ""), (b = this._.bodyRegExp.exec(a)) && b.length && (a = b[1], a = a.replace(this._.fragmentRegExp, ""))) : "Text" == b && CKEDITOR.env.gecko && this.getFilesCount() && "file://" == a.substring(0, 7) && (a = "");
                return a },
            setData: function(b,
                a) { b = this._.normalizeType(b);
                this._.data[b] = a;
